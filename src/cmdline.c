...
cmdline_parser_print_help (void)
{
  ...
  printf("%s\n","      --noutf8      Not use iconv filter to convert UTF-8 stream from/to system \n                    encoding  (default=off)");
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 0:	/* Long option with no short option */
          ...
          if (strcmp (long_options[option_index].name, "noutf8") == 0)
          {
            if (local_args_info.noutf8_given)
              {
                fprintf (stderr, "%s: `--noutf8' option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
                goto failure;
              }
            if (args_info->noutf8_given && ! override)
              continue;
            local_args_info.noutf8_given = 1;
            args_info->noutf8_given = 1;
            args_info->noutf8_flag = !(args_info->noutf8_flag);
          }
