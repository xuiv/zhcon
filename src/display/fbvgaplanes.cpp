...
#elif (defined(__FreeBSD__) || defined(__FreeBSD_kernel__)) && defined(__x86_64__)
    amd64_set_ioperm(GRAPHICS_ADDR_REG, 1, 1);
    amd64_set_ioperm(GRAPHICS_DATA_REG, 1, 1);
#endif
    SetDefaultMode();
}
...
#elif (defined(__FreeBSD__) || defined(__FreeBSD_kernel__)) && defined(__x86_64__)
    amd64_set_ioperm(GRAPHICS_ADDR_REG, 1, 0);
    amd64_set_ioperm(GRAPHICS_DATA_REG, 1, 0);
#endif
}
